...
* Rename the rubrics/ folder to the name of your report (eg "widget").
...
* Edit all the files in this directory and its subdirectories and change
  all the instances of the string "rubrics" to your report name
  (eg "widget"). If you are using Linux, you can use the following command
  $ find . -type f -exec sed -i 's/rubrics/widget/g' {} \;
